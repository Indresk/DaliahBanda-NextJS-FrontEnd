	...
	return (
		<>
			...
			<div className='relative'>
				...
				<div className='w-full absolute bottom-0 left-0 z-[-2] aspect-4/3 md:aspect-5/2'>
					<Image
						width={1622}
						height={1080}
						loading='eager'
					...
					/>
					<div className='absolute inset-0 z-[-1] bg-linear-to-b from-black via-black/60 to-transparent' />
				</div>
			</div>
